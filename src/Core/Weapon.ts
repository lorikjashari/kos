...
export const WEAPONS: Record<string, WeaponConfig> = {
  ...
  /** Slot 3 — butterfly viewmodel (hands + procedural open). Same melee rules as Knife. */
  Butterfly: {
    key: 'Butterfly',
  ...
  /** CS MDL karambit on M9 hands — same melee rules as Knife. */
  Karambit: {
    key: 'Karambit',
